...
train = pd.read_csv('C:/Users/min98/Desktop/ESAA/0529_titanic사례실습/input/train.csv')
test = pd.read_csv('C:/Users/min98/Desktop/ESAA/0529_titanic사례실습/input/test.csv')
...
dataset.loc[(dataset['Age']>36) & (dataset['Age'<=626), 'Age']=3,
